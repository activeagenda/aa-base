...
define('FORM_DROPLIST_HTML', '%4$s <select class="edt %6$s" name="%1$s" id="id%1$s" onchange="%3$s" onfocusin="this.style.backgroundColor=\'#e6f1ff\'" onfocusout="this.style.backgroundColor=\'#ffffff\'">%2$s</select> %5$s');
...
-->
    ...
    %8$s
    <select class="edt %10$s" name="%2$s" id="id%2$s" onchange="%7$s" onfocusin="this.style.backgroundColor=\'#e6f1ff\'" onfocusout="this.style.backgroundColor=\'#ffffff\'"><option/></select>
    <script type="text/javascript">
    <!--
    //[js:]
...
define('FORM_PERSON_CB_HTML', '
    ...
    %6$s <select class="edt" id="%2$s_org" name="%2$s_org" onchange="ReloadPeople(\'%1$s\', \'%2$s\', this.value, ar%2$sPeople)"  onfocusin="this.style.backgroundColor=\'#e6f1ff\'" onfocusout="this.style.backgroundColor=\'#ffffff\'"></select><br />
    %5$s <select class="edt" id="%2$s" name="%2$s"  onfocusin="this.style.backgroundColor=\'#e6f1ff\'" onfocusout="this.style.backgroundColor=\'#ffffff\'"></select>
    <script type="text/javascript">
    <!--
    //[js:]
