DELETE FROM codt WHERE CodeTypeID IN (1,2,7,10,124,138,170,194,199,261,272,281,302,999);
...
INSERT INTO codt (CodeTypeID,Name,Description,UseValue,_ModBy,_ModDate,_Deleted)
            VALUES ('999','Granica zasstrzeżonych kodów','Granica zastrzeżonej numeracji kodów','0','3','2007-11-01 13:46:23','0');
DELETE FROM cod WHERE CodeTypeID IN (1,2,7,10,124,138,170,194,199,261,272,281,302,999);
...
INSERT INTO cod (CodeTypeID,CodeID,SortOrder,Value,Description,_ModBy,_ModDate,_Deleted)
            VALUES ('194','2',NULL,NULL,'Trochę dokuemntacji','3','2006-03-21 11:32:57','0');
INSERT INTO cod (CodeTypeID,CodeID,SortOrder,Value,Description,_ModBy,_ModDate,_Deleted)
