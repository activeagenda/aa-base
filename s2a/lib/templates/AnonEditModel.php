 ...
 * @version        SVN: $Revision: 1161 $
 * @last-modified  SVN: $Date: 2008-03-22 00:56:37 -0500 (Sat, 22 Mar 2008) $
 */
...
//initializes variable for auto-close
$close_window_script = '';
...
$nextlink = "anonedit.php?$tabsQS&scr=$nextScreen";
$form_enctype = '';
...
if(!empty($_POST['Save'])){
    ...
    if (count($messages) == 0){
        ...
        //close window
         $close_window_script = "<script language=JavaScript>setTimeout(function(){window.open('popclose.html','_parent','');},5000);</script>";
    }
}
/**SQL|DELETE_BEGIN**/
...
$content = $close_window_script . $content;
