...
//END
    ...
    $phpcmd = findPHPexe();
//START
    $command = $phpcmd .' '. S2A_FOLDER."/s2a-generate-module.php -p $Project -m $moduleID $SaveNavigationPhrases_switch $ExportMasterData_switch $GenInfo_switch $central_addons_switch $NoMergeExport_switch $Language_switch 2>&1";
//END
